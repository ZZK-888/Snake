...
class Game {
    constructor(select, scoreEle, gameoverrbg) {
        ...
        this.setInterval_record = 100
        this.judge = 0 //辅助判断变量
        this.judge2 = 0 //辅助判断变量
    ...
    start() {
        ...
        if (!this.isRunning) {
            ...
            const move = () => {
                ...
                //20秒后方向恢复正常
                if (this.snake.cnt == 2) {
                    if (this.snacks_cnt == 2 && this.judge == 1) {
                        this.judge = 0
                        setTimeout(() => {
                            this.snake.cnt = 0
                ...
                //三秒后速度恢复正常
                if (this.setInterval_record == this.setInterval / 3 && this.judge2 == 1) {
                    this.judge2 = 0
                    setTimeout(() => {
                ...
                if (this.snake.isEatFood(this.food.x, this.food.y)) {
                    ...
                    this.snacks_cnt_no = 0
                    this.medicine_cnt_no = 0
                    if (this.food_cnt_no == 3 && this.snake.cnt == 2) {
                        this.snake.cnt = 0
                        //对方向的更新
                        if (this.snake.directhion === "left") {
                            this.snake.directhion = "right"
